...
<div class="callout-block panel">
    ...
    <div class="content">
        <h4 class="callout-title">
            3.	Contenidos: 
            <span class="btn-green btn-cta">Admin <i class="fa fa-check-circle-o"></i></span>
            <span class="btn-warning btn-cta">Gestor (Solo contenido propio)<i class="fa fa-warning"></i></span>
        </h4>
...
<div class="callout-block panel">
    ...
    <div class="content">
        <h4 class="callout-title">
            4.	Librería de bloques personalizados:  
            <span class="btn-green btn-cta">Admin <i class="fa fa-check-circle-o"></i></span>
            <span class="btn-green btn-cta">Gestor <i class="fa fa-check-circle-o"></i></span>
        </h4>
...
<div class="callout-block panel">
    ...
    <div class="content">
        <h4 class="callout-title">
            6.	Los modos de visualización: 
            <span class="btn-red btn-cta">Admin <i class="fa fa-times-circle-o"></i></span>
...
<div class="callout-block panel">
    ...
    <div class="content">
        <h4 class="callout-title">
            15.	 Apariencia del sitio:
            <span class="btn-warning btn-cta">Admin (Configuración)<i class="fa fa-warning"></i></span>
            <span class="btn-red btn-cta">Gestor <i class="fa fa-times-circle-o"></i></span>
        </h4>
