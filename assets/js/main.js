$(document).ready(function () {
    ...
    function openAlert() {
        Swal.fire({
            ...
            html: '<video id="guia" class="mt-5" autoplay loop controls width="100%" height="550"><source type="video/mp4" src="plantillabase.test-uniandes.acsitefactory.com/sites/g/files/hunrwv131/files/2023-12/Estrategia%20Web.mp4"></video>',
            width: '1000',
            backdrop: `
                rgba(0,0,0,0.4)
